...
void c_startup(void)
{
    ...
    extern uint8_t __fast_load_addr__[], __noncacheable_init_load_addr__[], __ardupilot_load_addr__[];
    ...
    extern uint8_t __ardupilot_ram_start__[], __ardupilot_ram_end__[];
    extern uint8_t __ardupilot_data_load_addr__[];
    extern uint8_t __ardupilot_init_start__[], __ardupilot_init_end__[];
    extern uint8_t __cpu1_slv_start__[], __cpu1_slv_end__[];
    ...
    /* bss section */
    size = __cpu1_slv_end__ - __cpu1_slv_start__;
    for (i = 0; i < size; i++) {
        *(__cpu1_slv_start__ + i) = 0;
    }

    size = __ardupilot_init_end__ - __ardupilot_init_start__;
    for (i = 0; i < size; i++) {
        *(__ardupilot_init_start__ + i) = *(__ardupilot_data_load_addr__ + i);
    }
    ...
    size = __ardupilot_ram_end__ - __ardupilot_ram_start__;
    for (i = 0; i < size; i++) {
        *(__ardupilot_ram_start__ + i) = *(__ardupilot_load_addr__ + i);
    }
